...
/**
 * 从 localStorage.clientPath 读取客户端路径，并调用 Rust command 启动 LOL。
 *
 * clientPath 由 background/utils/config.ts 通过 LCU install-dir 推导得到。
 * 如果是首次使用且还没有 clientPath，需要用户先手动打开一次客户端。
 */
